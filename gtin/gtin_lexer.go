...
// NewgtinLexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *gtinLexer instance produced may be reused by calling the SetInputStream method.
