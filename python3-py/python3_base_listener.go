...
// EnterStrr is called when production strr is entered.
func (s *BasePython3Listener) EnterStrr(ctx *StrrContext) {}

// ExitStrr is called when production strr is exited.
func (s *BasePython3Listener) ExitStrr(ctx *StrrContext) {}
