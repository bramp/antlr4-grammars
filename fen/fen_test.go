...
// Package fen_test contains tests for the fen grammar.
...
var examples = []string{
	"grammars-v4/fen/examples/example1.txt",
	"grammars-v4/fen/examples/example2.txt",
	"grammars-v4/fen/examples/example3.txt",
	"grammars-v4/fen/examples/example4.txt",
}
...
func TestFenLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewfenLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
