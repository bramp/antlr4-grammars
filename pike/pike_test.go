...
// Package pike_test contains tests for the pike grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := pike.NewpikeLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := pike.NewpikeParser(stream)
...
func TestPikeLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewpikeLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPikeParser(t *testing.T) {
