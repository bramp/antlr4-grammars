...
// Package bcl_test contains tests for the bcl grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := bcl.NewbclLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := bcl.NewbclParser(stream)
...
func TestBclLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewbclLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestBclParser(t *testing.T) {
