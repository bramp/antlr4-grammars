...
// Package asm8080_test contains tests for the asm8080 grammar.
...
//
package asm8080_test

import (
	"bramp.net/antlr4/asm8080"
...
var examples = []string{
	"grammars-v4/asm/asm8080/examples/CPM22.ASM",
}

type exampleListener struct {
	*asm8080.Baseasm8080Listener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := asm8080.Newasm8080Lexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := asm8080.Newasm8080Parser(stream)
...
func TestAsm8080Lexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := asm8080.Newasm8080Lexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("Newasm8080Lexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestAsm8080Parser(t *testing.T) {
