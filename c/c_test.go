...
// Package c_test contains tests for the C grammar.
...
var examples = []string{
	...
	"grammars-v4/c/examples/helloworld.c",
	"grammars-v4/c/examples/integrate.c",
	"grammars-v4/c/examples/ll.c",
	"grammars-v4/c/examples/pr403.c",
}
...
func TestCLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewCLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
