...
// Package restructuredtext_test contains tests for the ReStructuredText grammar.
...
func TestReStructuredTextLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := restructuredtext.NewReStructuredTextLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewReStructuredTextLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestReStructuredTextParser(t *testing.T) {
