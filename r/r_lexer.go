...
// NewRLexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *RLexer instance produced may be reused by calling the SetInputStream method.
