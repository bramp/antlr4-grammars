// Package r_test contains tests for the R grammar.
...
var examples = []string{
	"grammars-v4/r/examples/example1.txt",
	"grammars-v4/r/examples/example2.txt",
}
...
func TestRLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewRLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
