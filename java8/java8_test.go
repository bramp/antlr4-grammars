...
// Package java8_test contains tests for the Java8 grammar.
...
var examples = []string{
	"grammars-v4/java/java8/examples/Receiver.java",
	"grammars-v4/java/java8/examples/Unicode.java",
	"grammars-v4/java/java8/examples/helloworld.java",
	"grammars-v4/java/java8/examples/instanceof.java",
}
...
func Example() {
	...
	// Create the Lexer
	lexer := java8.NewJava8Lexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := java8.NewJava8Parser(stream)
...
func TestJava8Lexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewJava8Lexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestJava8Parser(t *testing.T) {
