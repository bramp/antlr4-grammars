...
// Package graphemes_test contains tests for the Graphemes grammar.
...
var examples = []string{
	"grammars-v4/unicode/graphemes/examples/ascii.txt",
	"grammars-v4/unicode/graphemes/examples/emoji.txt",
	"grammars-v4/unicode/graphemes/examples/udhr.txt",
}
...
func TestGraphemesLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := graphemes.NewGraphemesLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewGraphemesLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestGraphemesParser(t *testing.T) {
