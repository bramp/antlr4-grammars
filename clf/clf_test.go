...
var examples = []string{
	"grammars-v4/clf/examples/access_log",
	"grammars-v4/clf/examples/combined1.txt",
	"grammars-v4/clf/examples/common1.txt",
	"grammars-v4/clf/examples/problem1.txt",
}
