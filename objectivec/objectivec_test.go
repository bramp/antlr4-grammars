...
// Package objectivec_test contains tests for the ObjectiveC grammar.
...
func TestObjectiveCLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := objectivec.NewObjectiveCLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewObjectiveCLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestObjectiveCParser(t *testing.T) {
