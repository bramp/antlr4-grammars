// Package scss_test contains tests for the Scss grammar.
...
import (
	"bramp.net/antlr4-grammars/scss"
	"fmt"
...
var examples = []string{
	"grammars-v4/scss/examples/example1.txt",
}
...
func TestScssLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewScssLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestScssParser(t *testing.T) {
