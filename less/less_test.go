...
import (
	...
	"bramp.net/antlr4-grammars/less"
...
func TestLessLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewLessLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestLessParser(t *testing.T) {
