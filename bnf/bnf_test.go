...
// Package bnf_test contains tests for the bnf grammar.
...
var examples = []string{
	"grammars-v4/bnf/examples/postal.bnf",
}
...
func TestBnfLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewbnfLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestBnfParser(t *testing.T) {
