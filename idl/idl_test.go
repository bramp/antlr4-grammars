// Package idl_test contains tests for the IDL grammar.
...
func TestIDLLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewIDLLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
