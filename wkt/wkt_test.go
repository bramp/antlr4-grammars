...
// Package wkt_test contains tests for the wkt grammar.
...
var examples = []string{
	"grammars-v4/wkt/examples/example1.txt",
}
...
func TestWktLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewwktLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestWktParser(t *testing.T) {
