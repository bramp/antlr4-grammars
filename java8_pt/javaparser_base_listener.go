...
func (s *BaseJavaParserListener) EnterMethodReference(ctx *MethodReferenceContext) {}

// ExitMethodReference is called when production methodReference is exited.
func (s *BaseJavaParserListener) ExitMethodReference(ctx *MethodReferenceContext) {}
