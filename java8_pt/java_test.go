...
// Package java8-pt_test contains tests for the Java grammar.
...
//
package java8_pt_test

import (
	"bramp.net/antlr4-grammars/internal"
	"bramp.net/antlr4-grammars/java8_pt"
...
var examples = []string{
	"grammars-v4/java8-pt/examples/AllInOne8.java",
}

type exampleListener struct {
	*java8_pt.BaseJavaParserListener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := java8_pt.NewJavaLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := java8_pt.NewJavaParser(stream)
...
func TestJavaLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := java8_pt.NewJavaLexer(input)
