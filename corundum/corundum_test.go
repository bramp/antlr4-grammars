...
// Package corundum_test contains tests for the Corundum grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := corundum.NewCorundumLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := corundum.NewCorundumParser(stream)
...
func TestCorundumLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := corundum.NewCorundumLexer(input)
