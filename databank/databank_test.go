...
// Package databank_test contains tests for the databank grammar.
...
var examples = []string{
	"grammars-v4/databank/examples/example1.db",
	"grammars-v4/databank/examples/example2.db",
	"grammars-v4/databank/examples/example3.db",
	"grammars-v4/databank/examples/example4.db",
	"grammars-v4/databank/examples/example5.db",
}
...
func TestDatabankLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := databank.NewdatabankLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewdatabankLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestDatabankParser(t *testing.T) {
