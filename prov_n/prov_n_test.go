...
// Package prov_n_test contains tests for the PROV_N grammar.
...
var examples = []string{
	"grammars-v4/prov-n/examples/example1.provn",
	"grammars-v4/prov-n/examples/example2.provn",
	"grammars-v4/prov-n/examples/example3.provn",
	"grammars-v4/prov-n/examples/example4.provn",
}
...
func TestPROV_NLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := prov_n.NewPROV_NLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewPROV_NLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPROV_NParser(t *testing.T) {
