...
// Package rcs_test contains tests for the RCS grammar.
...
func TestRCSLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewRCSLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
