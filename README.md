...
| ❌  | arithmetic      | test: FAIL   bramp.net/antlr4/arithmetic     0.030s                               |
...
| ❌  | cobol85preprocessor | test: FAIL       bramp.net/antlr4/cobol85preprocessor [build failed]              |
...
| ❌  | ecmascript      | maketest: exit status 1                                                     |
...
| ❌  | gtin            | test: FAIL   bramp.net/antlr4/gtin   0.050s                                     |
| ❌  | html            | test: FAIL   bramp.net/antlr4/html   10.033s                                    |
...
| ❌  | java            | test: FAIL   bramp.net/antlr4/java   10.053s                                    |
...
| ❌  | lexunicode      | test: FAIL   bramp.net/antlr4/lexunicode [build failed]                       |
...
| ❌  | morsecode       | test: FAIL   bramp.net/antlr4/morsecode      0.025s                                |
| ❌  | mysql           | build:       previous declaration at mysql/mysql_parser.go:11965:6               |
| ❌  | objectivec      | maketest: exit status 2                                                     |
...
| ❌  | r               | test: FAIL   bramp.net/antlr4/r [build failed]                                |
...
| ❌  | unicodeclasses  | test: FAIL   bramp.net/antlr4/unicodeclasses [build failed]                   |
...
| ❌  | vhdl            | test: FAIL   bramp.net/antlr4/vhdl   10.065s                                    |
