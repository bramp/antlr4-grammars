...
// Package cobol85preprocessor_test contains tests for the Cobol85 grammar.
...
//
package cobol85preprocessor_test
...
var examples = []string{
	"grammars-v4/cobol85/examples/example1.txt",
}
...
func TestCobol85PreprocessorLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := cobol85preprocessor.NewCobol85PreprocessorLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewCobol85PreprocessorLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestCobol85PreprocessorParser(t *testing.T) {
