...
// Package clu_test contains tests for the clu grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := clu.NewcluLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := clu.NewcluParser(stream)
...
func TestCluLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewcluLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestCluParser(t *testing.T) {
