...
// NewDCM_2_0_grammarLexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *DCM_2_0_grammarLexer instance produced may be reused by calling the SetInputStream method.
