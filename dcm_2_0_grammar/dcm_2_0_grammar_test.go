...
// Package dcm_2_0_grammar_test contains tests for the DCM_2_0_grammar grammar.
...
//
package dcm_2_0_grammar_test

import (
	"bramp.net/antlr4/dcm_2_0_grammar"
...
type exampleListener struct {
	*dcm_2_0_grammar.BaseDCM_2_0_grammarListener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := dcm_2_0_grammar.NewDCM_2_0_grammarLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := dcm_2_0_grammar.NewDCM_2_0_grammarParser(stream)
...
func TestDCM_2_0_grammarLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := dcm_2_0_grammar.NewDCM_2_0_grammarLexer(input)
