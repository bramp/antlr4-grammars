...
// Package pmmn_test contains tests for the PMMN grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := pmmn.NewPMMNLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := pmmn.NewPMMNParser(stream)
...
func TestPMMNLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewPMMNLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPMMNParser(t *testing.T) {
