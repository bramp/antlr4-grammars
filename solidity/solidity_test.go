...
// Package solidity_test contains tests for the Solidity grammar.
...
func TestSolidityLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := solidity.NewSolidityLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewSolidityLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestSolidityParser(t *testing.T) {
