...
// Package beep_test contains tests for the beep grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := beep.NewbeepLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := beep.NewbeepParser(stream)
...
func TestBeepLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewbeepLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestBeepParser(t *testing.T) {
