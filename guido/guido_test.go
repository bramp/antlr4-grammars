...
// Package guido_test contains tests for the guido grammar.
...
var examples = []string{
	"grammars-v4/guido/examples/example1.txt",
	"grammars-v4/guido/examples/example2.txt",
	"grammars-v4/guido/examples/example3.txt",
}
...
func TestGuidoLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := guido.NewguidoLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewguidoLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestGuidoParser(t *testing.T) {
