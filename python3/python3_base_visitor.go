...
func (v *BasePython3Visitor) VisitAsync_funcdef(ctx *Async_funcdefContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePython3Visitor) VisitAnnassign(ctx *AnnassignContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePython3Visitor) VisitAsync_stmt(ctx *Async_stmtContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePython3Visitor) VisitAtom_expr(ctx *Atom_exprContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePython3Visitor) VisitEncoding_decl(ctx *Encoding_declContext) interface{} {
	return v.VisitChildren(ctx)
}
