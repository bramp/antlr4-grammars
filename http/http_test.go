...
// Package http_test contains tests for the http grammar.
...
func TestHttpLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewhttpLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
