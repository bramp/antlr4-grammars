...
// Package pl0_test contains tests for the pl0 grammar.
...
var examples = []string{
	"grammars-v4/pl0/examples/example1.txt",
	"grammars-v4/pl0/examples/example2.txt",
	"grammars-v4/pl0/examples/example3.txt",
}
...
func Example() {
	...
	// Create the Lexer
	lexer := pl0.Newpl0Lexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := pl0.Newpl0Parser(stream)
...
func TestPl0Lexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("Newpl0Lexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPl0Parser(t *testing.T) {
