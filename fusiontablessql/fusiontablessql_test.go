...
// Package fusiontablessql_test contains tests for the FusionTablesSql grammar.
...
func TestFusionTablesSqlLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := fusiontablessql.NewFusionTablesSqlLexer(input)
