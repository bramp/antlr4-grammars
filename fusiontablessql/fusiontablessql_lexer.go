...
// NewFusionTablesSqlLexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *FusionTablesSqlLexer instance produced may be reused by calling the SetInputStream method.
