...
var parserATN = []uint16{
	...
	5, 3, 2, 2, 2, 23, 24, 7, 17, 2, 2, 24, 27, 7, 38, 2, 2, 25, 26, 7, 23,
	2, 2, 26, 28, 7, 38, 2, 2, 27, 25, 3, 2, 2, 2, 27, 28, 3, 2, 2, 2, 28,
	...
	38, 39, 7, 5, 2, 2, 39, 7, 3, 2, 2, 2, 40, 41, 7, 39, 2, 2, 41, 52, 7,
	...
	7, 38, 2, 2, 58, 59, 7, 4, 2, 2, 59, 60, 5, 12, 7, 2, 60, 61, 7, 5, 2,
	2, 61, 70, 3, 2, 2, 2, 62, 63, 7, 39, 2, 2, 63, 64, 7, 9, 2, 2, 64, 67,
	7, 38, 2, 2, 65, 66, 7, 40, 2, 2, 66, 68, 5, 12, 7, 2, 67, 65, 3, 2, 2,
	2, 67, 68, 3, 2, 2, 2, 68, 70, 3, 2, 2, 2, 69, 40, 3, 2, 2, 2, 69, 62,
	3, 2, 2, 2, 70, 9, 3, 2, 2, 2, 71, 72, 7, 39, 2, 2, 72, 73, 7, 9, 2, 2,
	73, 74, 7, 38, 2, 2, 74, 11, 3, 2, 2, 2, 75, 76, 8, 7, 1, 2, 76, 77, 7,
	39, 2, 2, 77, 88, 7, 6, 2, 2, 78, 83, 5, 12, 7, 2, 79, 80, 7, 7, 2, 2,
	...
	7, 21, 2, 2, 93, 94, 5, 12, 7, 2, 94, 95, 7, 28, 2, 2, 95, 96, 5, 12, 7,
	2, 96, 97, 7, 18, 2, 2, 97, 98, 5, 12, 7, 2, 98, 99, 7, 20, 2, 2, 99, 176,
	3, 2, 2, 2, 100, 101, 7, 29, 2, 2, 101, 102, 5, 12, 7, 2, 102, 103, 7,
	26, 2, 2, 103, 104, 5, 12, 7, 2, 104, 105, 7, 27, 2, 2, 105, 176, 3, 2,
	...
	7, 5, 2, 2, 115, 176, 3, 2, 2, 2, 116, 117, 7, 25, 2, 2, 117, 118, 7, 39,
	2, 2, 118, 119, 7, 9, 2, 2, 119, 122, 7, 38, 2, 2, 120, 121, 7, 40, 2,
	2, 121, 123, 5, 12, 7, 2, 122, 120, 3, 2, 2, 2, 122, 123, 3, 2, 2, 2, 123,
	134, 3, 2, 2, 2, 124, 125, 7, 7, 2, 2, 125, 126, 7, 39, 2, 2, 126, 127,
	7, 9, 2, 2, 127, 130, 7, 38, 2, 2, 128, 129, 7, 40, 2, 2, 129, 131, 5,
	...
	7, 22, 2, 2, 138, 176, 5, 12, 7, 22, 139, 140, 7, 30, 2, 2, 140, 141, 5,
	12, 7, 2, 141, 149, 7, 33, 2, 2, 142, 143, 7, 39, 2, 2, 143, 144, 7, 9,
	2, 2, 144, 145, 7, 38, 2, 2, 145, 146, 7, 41, 2, 2, 146, 147, 5, 12, 7,
	2, 147, 148, 7, 3, 2, 2, 148, 150, 3, 2, 2, 2, 149, 142, 3, 2, 2, 2, 150,
	151, 3, 2, 2, 2, 151, 149, 3, 2, 2, 2, 151, 152, 3, 2, 2, 2, 152, 153,
	3, 2, 2, 2, 153, 154, 7, 31, 2, 2, 154, 176, 3, 2, 2, 2, 155, 156, 7, 32,
	2, 2, 156, 176, 7, 38, 2, 2, 157, 158, 7, 49, 2, 2, 158, 176, 5, 12, 7,
	19, 159, 160, 7, 24, 2, 2, 160, 176, 5, 12, 7, 18, 161, 162, 7, 34, 2,
	2, 162, 176, 5, 12, 7, 10, 163, 164, 7, 6, 2, 2, 164, 165, 5, 12, 7, 2,
	165, 166, 7, 8, 2, 2, 166, 176, 3, 2, 2, 2, 167, 176, 7, 39, 2, 2, 168,
	176, 7, 37, 2, 2, 169, 176, 7, 36, 2, 2, 170, 176, 7, 35, 2, 2, 171, 176,
	7, 19, 2, 2, 172, 173, 7, 39, 2, 2, 173, 174, 7, 40, 2, 2, 174, 176, 5,
	...
	179, 7, 44, 2, 2, 179, 221, 5, 12, 7, 18, 180, 181, 12, 16, 2, 2, 181,
	182, 7, 45, 2, 2, 182, 221, 5, 12, 7, 17, 183, 184, 12, 15, 2, 2, 184,
	185, 7, 42, 2, 2, 185, 221, 5, 12, 7, 16, 186, 187, 12, 14, 2, 2, 187,
	188, 7, 43, 2, 2, 188, 221, 5, 12, 7, 15, 189, 190, 12, 13, 2, 2, 190,
	191, 7, 46, 2, 2, 191, 221, 5, 12, 7, 14, 192, 193, 12, 12, 2, 2, 193,
	194, 7, 47, 2, 2, 194, 221, 5, 12, 7, 13, 195, 196, 12, 11, 2, 2, 196,
	197, 7, 48, 2, 2, 197, 221, 5, 12, 7, 12, 198, 201, 12, 27, 2, 2, 199,
	200, 7, 10, 2, 2, 200, 202, 7, 38, 2, 2, 201, 199, 3, 2, 2, 2, 201, 202,
	3, 2, 2, 2, 202, 203, 3, 2, 2, 2, 203, 204, 7, 11, 2, 2, 204, 205, 7, 39,
...
const (
	...
	COOLParserT__7             = 8
	COOLParserT__8             = 9
	COOLParserWHITESPACE       = 10
	COOLParserOPEN_COMMENT     = 11
	COOLParserCLOSE_COMMENT    = 12
	COOLParserCOMMENT          = 13
	COOLParserONE_LINE_COMMENT = 14
	COOLParserCLASS            = 15
	COOLParserELSE             = 16
	COOLParserFALSE            = 17
	COOLParserFI               = 18
	...
	COOLParserINT              = 35
	COOLParserTYPEID           = 36
	COOLParserOBJECTID         = 37
	COOLParserASSIGNMENT       = 38
	COOLParserCASE_ARROW       = 39
	COOLParserADD              = 40
	COOLParserMINUS            = 41
	COOLParserMULTIPLY         = 42
	COOLParserDIVISION         = 43
	COOLParserLESS_THAN        = 44
	COOLParserLESS_EQUAL       = 45
	COOLParserEQUAL            = 46
	COOLParserINTEGER_NEGATIVE = 47
)
...
func (s *ClassesContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitClasses(s)
...
func (s *FormalContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitFormal(s)
...
func (s *LetInContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitLetIn(s)
...
func (s *IsvoidContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitIsvoid(s)
...
func (s *BoolNotContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitBoolNot(s)
...
func (s *OwnMethodCallContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitOwnMethodCall(s)
...
func (s *NewContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitNew(s)
...
func (s *LessEqualContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case COOLVisitor:
		return t.VisitLessEqual(s)
...
func (p *COOLParser) expression(_p int) (localctx IExpressionContext) {
	...
	case 1:
		...
		for (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<COOLParserT__1)|(1<<COOLParserT__3)|(1<<COOLParserFALSE)|(1<<COOLParserIF)|(1<<COOLParserISVOID)|(1<<COOLParserLET)|(1<<COOLParserWHILE)|(1<<COOLParserCASE)|(1<<COOLParserNEW))) != 0) || (((_la-32)&-(0x1f+1)) == 0 && ((1<<uint((_la-32)))&((1<<(COOLParserNOT-32))|(1<<(COOLParserTRUE-32))|(1<<(COOLParserSTRING-32))|(1<<(COOLParserINT-32))|(1<<(COOLParserOBJECTID-32))|(1<<(COOLParserINTEGER_NEGATIVE-32)))) != 0) {
			{
				p.SetState(76)
				p.expression(0)
			}
	...
	case 4:
		...
		for ok := true; ok; ok = (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<COOLParserT__1)|(1<<COOLParserT__3)|(1<<COOLParserFALSE)|(1<<COOLParserIF)|(1<<COOLParserISVOID)|(1<<COOLParserLET)|(1<<COOLParserWHILE)|(1<<COOLParserCASE)|(1<<COOLParserNEW))) != 0) || (((_la-32)&-(0x1f+1)) == 0 && ((1<<uint((_la-32)))&((1<<(COOLParserNOT-32))|(1<<(COOLParserTRUE-32))|(1<<(COOLParserSTRING-32))|(1<<(COOLParserINT-32))|(1<<(COOLParserOBJECTID-32))|(1<<(COOLParserINTEGER_NEGATIVE-32)))) != 0) {
			{
				p.SetState(105)
				p.expression(0)
			}
