...
// Package lexunicode_test contains tests for the ST grammar.
...
var examples = []string{
	"grammars-v4/stringtemplate/examples/example1.st",
}
...
func TestLexUnicode(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := lexunicode.NewLexUnicode(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewLexUnicode(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
