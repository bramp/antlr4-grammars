...
// Package tsv_test contains tests for the tsv grammar.
...
var examples = []string{
	"grammars-v4/tsv/examples/example1.txt",
}
...
func TestTsvLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewtsvLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
