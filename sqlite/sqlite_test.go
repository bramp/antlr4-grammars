...
// Package sqlite_test contains tests for the SQLite grammar.
...
var examples = []string{
	"grammars-v4/sql/sqlite/examples/WindowsFunctionsForSqLite.sql",
	"grammars-v4/sql/sqlite/examples/sql1.sql",
	"grammars-v4/sql/sqlite/examples/sql2.sql",
	"grammars-v4/sql/sqlite/examples/sql3.sql",
}
...
func TestSQLiteLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewSQLiteLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
