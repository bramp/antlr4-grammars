...
// Package iri_test contains tests for the IRI grammar.
...
var examples = []string{
	"grammars-v4/iri/examples/example1.iri",
...
func TestIRILexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewIRILexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
