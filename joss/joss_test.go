...
// Package joss_test contains tests for the joss grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := joss.NewjossLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := joss.NewjossParser(stream)
...
func TestJossLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewjossLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestJossParser(t *testing.T) {
