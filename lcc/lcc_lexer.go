...
// NewlccLexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *lccLexer instance produced may be reused by calling the SetInputStream method.
