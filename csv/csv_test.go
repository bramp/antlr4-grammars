// Package csv_test contains tests for the CSV grammar.
...
var examples = []string{
	"grammars-v4/csv/examples/example1.csv",
}
...
func TestCSVLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewCSVLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
