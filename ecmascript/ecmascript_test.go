...
// Package ecmascript_test contains tests for the ECMAScript grammar.
...
func TestECMAScriptLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := ecmascript.NewECMAScriptLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewECMAScriptLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestECMAScriptParser(t *testing.T) {
