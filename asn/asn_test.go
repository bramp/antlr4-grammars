...
// Package asn_test contains tests for the ASN grammar.
...
func TestASNLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewASNLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestASNParser(t *testing.T) {
