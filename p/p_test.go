...
// Package p_test contains tests for the p grammar.
...
var examples = []string{
	"grammars-v4/p/examples/example1.txt",
	"grammars-v4/p/examples/example2.txt",
}
...
func TestPLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i == MAX_TOKENS {
			t.Errorf("NewpLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPParser(t *testing.T) {
