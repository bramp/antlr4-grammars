...
// Package tinybasic_test contains tests for the tinybasic grammar.
...
var examples = []string{
	"grammars-v4/tinybasic/examples/example1.txt",
}
...
func TestTinybasicLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := tinybasic.NewtinybasicLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewtinybasicLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestTinybasicParser(t *testing.T) {
