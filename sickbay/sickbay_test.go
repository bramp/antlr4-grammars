...
// Package sickbay_test contains tests for the sickbay grammar.
...
//
package sickbay_test

import (
	"bramp.net/antlr4/internal"
	"bramp.net/antlr4/sickbay"
...
var examples = []string{
	"grammars-v4/sickbay/examples/hello.txt",
}

type exampleListener struct {
	*sickbay.BasesickbayListener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := sickbay.NewsickbayLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := sickbay.NewsickbayParser(stream)
...
func TestSickbayLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := sickbay.NewsickbayLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewsickbayLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestSickbayParser(t *testing.T) {
