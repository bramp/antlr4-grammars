...
import (
	...
	"bramp.net/antlr4-grammars/redcode"
...
var examples = []string{
	"grammars-v4/redcode/examples/bigfoot.txt",
	"grammars-v4/redcode/examples/dwarf.txt",
	"grammars-v4/redcode/examples/gemini.txt",
	"grammars-v4/redcode/examples/imp.txt",
	"grammars-v4/redcode/examples/mortar.txt",
}
...
func TestRedcodeLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := redcode.NewredcodeLexer(input)
		...
		if i == MAX_TOKENS {
			t.Errorf("NewredcodeLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
