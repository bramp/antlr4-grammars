...
// Package tl_test contains tests for the tl grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := tl.NewtlLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := tl.NewtlParser(stream)
...
func TestTlLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewtlLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestTlParser(t *testing.T) {
