...
// powerbuilderListener is a complete listener for a parse tree produced by powerbuilderParser.
type powerbuilderListener interface {
	...
	// EnterSwallow_to_newline is called when entering the swallow_to_newline production.
	EnterSwallow_to_newline(c *Swallow_to_newlineContext)
	...
	// ExitSwallow_to_newline is called when exiting the swallow_to_newline production.
	ExitSwallow_to_newline(c *Swallow_to_newlineContext)
