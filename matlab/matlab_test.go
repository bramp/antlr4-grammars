...
// Package matlab_test contains tests for the matlab grammar.
...
func TestMatlabLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := matlab.NewmatlabLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewmatlabLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestMatlabParser(t *testing.T) {
