// Package datetime_test contains tests for the datetime grammar.
...
import (
	"bramp.net/antlr4test-go/datetime"
...
var examples = []string{
	"grammars-v4/datetime/examples/example1.txt",
	"grammars-v4/datetime/examples/example2.txt",
}
...
func TestdatetimeLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := datetime.NewdatetimeLexer(input)
		...
		if i == MAX_TOKENS {
			t.Errorf("NewdatetimeLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
