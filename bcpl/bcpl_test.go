...
// Package bcpl_test contains tests for the bcpl grammar.
...
var examples = []string{
	"grammars-v4/bcpl/examples/cg8086.b",
	"grammars-v4/bcpl/examples/fact.bcpl",
	"grammars-v4/bcpl/examples/fib.bcpl",
	"grammars-v4/bcpl/examples/hw.bcpl",
	"grammars-v4/bcpl/examples/interp.b",
	"grammars-v4/bcpl/examples/unify.b",
}

type exampleListener struct {
	*bcpl.BasebcplListener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := bcpl.NewbcplLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := bcpl.NewbcplParser(stream)
...
func TestBcplLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewbcplLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestBcplParser(t *testing.T) {
