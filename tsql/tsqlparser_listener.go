...
type TSqlParserListener interface {
	...
	// EnterCreate_symmetric_key is called when entering the create_symmetric_key production.
	EnterCreate_symmetric_key(c *Create_symmetric_keyContext)
	...
	// EnterSearch_condition_and is called when entering the search_condition_and production.
	EnterSearch_condition_and(c *Search_condition_andContext)

	// EnterSearch_condition_not is called when entering the search_condition_not production.
	EnterSearch_condition_not(c *Search_condition_notContext)
	...
	// ExitCreate_symmetric_key is called when exiting the create_symmetric_key production.
	ExitCreate_symmetric_key(c *Create_symmetric_keyContext)
	...
	// ExitSearch_condition_and is called when exiting the search_condition_and production.
	ExitSearch_condition_and(c *Search_condition_andContext)

	// ExitSearch_condition_not is called when exiting the search_condition_not production.
	ExitSearch_condition_not(c *Search_condition_notContext)
