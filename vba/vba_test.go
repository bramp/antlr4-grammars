...
// Package vba_test contains tests for the vba grammar.
...
var examples = []string{
	"grammars-v4/vba/examples/example1.bas",
	"grammars-v4/vba/examples/example2operators.bas",
	"grammars-v4/vba/examples/example3erase.bas",
	"grammars-v4/vba/examples/example4fixedstring.bas",
}
...
func Example() {
	...
	// Create the Lexer
	lexer := vba.NewvbaLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := vba.NewvbaParser(stream)
...
func TestVbaLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewvbaLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestVbaParser(t *testing.T) {
