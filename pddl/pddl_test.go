...
// Package pddl_test contains tests for the Pddl grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := pddl.NewPddlLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := pddl.NewPddlParser(stream)
...
func TestPddlLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewPddlLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPddlParser(t *testing.T) {
