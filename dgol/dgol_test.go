...
// Package dgol_test contains tests for the dgol grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := dgol.NewdgolLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := dgol.NewdgolParser(stream)
...
func TestDgolLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewdgolLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestDgolParser(t *testing.T) {
