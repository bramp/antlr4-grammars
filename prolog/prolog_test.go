...
// Package prolog_test contains tests for the prolog grammar.
...
var examples = []string{
	"grammars-v4/prolog/examples/example1.txt",
}
...
func TestPrologLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := prolog.NewprologLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewprologLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestPrologParser(t *testing.T) {
