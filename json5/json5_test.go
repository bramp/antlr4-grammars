...
// Package json5_test contains tests for the JSON5 grammar.
...
var examples = []string{
	"grammars-v4/json5/examples/example1.json",
	"grammars-v4/json5/examples/example2.json5",
	"grammars-v4/json5/examples/example3.json5",
	"grammars-v4/json5/examples/example4.json5",
	"grammars-v4/json5/examples/issue1960.json5",
}

type exampleListener struct {
	*json5.BaseJSON5Listener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := json5.NewJSON5Lexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := json5.NewJSON5Parser(stream)
...
func TestJSON5Lexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := json5.NewJSON5Lexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewJSON5Lexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestJSON5Parser(t *testing.T) {
