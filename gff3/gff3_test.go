...
// Package gff3_test contains tests for the gff3 grammar.
...
var examples = []string{
	"grammars-v4/gff3/examples/NC_001633.gff",
	"grammars-v4/gff3/examples/NC_001792.gff",
}

type exampleListener struct {
	*gff3.Basegff3Listener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := gff3.Newgff3Lexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := gff3.Newgff3Parser(stream)
...
func TestGff3Lexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("Newgff3Lexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestGff3Parser(t *testing.T) {
