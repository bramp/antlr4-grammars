// Package mumath_test contains tests for the mumath grammar.
...
import (
	"bramp.net/antlr4-grammars/mumath"
	"fmt"
...
var examples = []string{
	"grammars-v4/mumath/examples/example1.txt",
}
...
func TestmumathLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := mumath.NewmumathLexer(input)
		...
		if i == MAX_TOKENS {
			t.Errorf("NewmumathLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestmumathParser(t *testing.T) {
