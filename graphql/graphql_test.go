...
// Package graphql_test contains tests for the GraphQL grammar.
...
func Example() {
	...
	// Create the Lexer
	lexer := graphql.NewGraphQLLexer(is)
...
func TestGraphQLLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := graphql.NewGraphQLLexer(input)
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewGraphQLLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}
