...
// Package upnp_test contains tests for the Upnp grammar.
...
var examples = []string{
	"grammars-v4/upnp/examples/search1.upnp",
	"grammars-v4/upnp/examples/search2.upnp",
	"grammars-v4/upnp/examples/search3.upnp",
	"grammars-v4/upnp/examples/search4.upnp",
	"grammars-v4/upnp/examples/search5.upnp",
}

type exampleListener struct {
	*upnp.BaseUpnpListener
}
...
func Example() {
	...
	// Create the Lexer
	lexer := upnp.NewUpnpLexer(is)
	stream := antlr.NewCommonTokenStream(lexer, antlr.TokenDefaultChannel)

	// Create the Parser
	p := upnp.NewUpnpParser(stream)
...
func TestUpnpLexer(t *testing.T) {
	for _, file := range examples {
		...
		if i >= MAX_TOKENS {
			t.Errorf("NewUpnpLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestUpnpParser(t *testing.T) {
