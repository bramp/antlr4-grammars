// Package morsecode_test contains tests for the morsecode grammar.
...
import (
	...
	"bramp.net/antlr4-grammars/morsecode"
...
var examples = []string{
	"grammars-v4/morsecode/examples/SMS.txt",
	"grammars-v4/morsecode/examples/SMS.txt.tree",
	"grammars-v4/morsecode/examples/SOS.txt",
	"grammars-v4/morsecode/examples/SOS.txt.tree",
}
...
func TestmorsecodeLexer(t *testing.T) {
	for _, file := range examples {
		...
		// Create the Lexer
		lexer := morsecode.NewmorsecodeLexer(input)
		...
		if i == MAX_TOKENS {
			t.Errorf("NewmorsecodeLexer(%q) read %d tokens without finding EOF", file, i)
		}
	}
}

func TestmorsecodeParser(t *testing.T) {
